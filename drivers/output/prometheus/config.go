...
type MetricConfig struct {
	...
	Objectives  map[float64]float64 `json:"objectives" yaml:"objectives" label:"quantiles 分位数值" description:"当收集类型为request_timing,request_retry,request_req,request_resp,proxy_timing,proxy_req,proxy_resp时选填"`
