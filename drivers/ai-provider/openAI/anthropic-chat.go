...
const (
	...
	labelStreamRemain          = "openai_anthropic_stream_remain"
	labelStreamStarted         = "openai_anthropic_stream_started"
	labelStreamTextStarted     = "openai_anthropic_stream_text_started"
	labelStreamActiveToolIndex = "openai_anthropic_stream_active_tool_idx"
	labelStreamOutputTokens    = "openai_anthropic_stream_output_tokens"
)
