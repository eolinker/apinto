...
func init() {
	driverCreate.Set(ai_convert.ModelTypeChat, NewChat)
}

func NewChat(conf *Config) (ai_convert.IConverterDriver, error) {
	return ai_convert.NewOpenAIChat(provider, conf.APIKey, conf.BaseUrl, 0, nil, errorCallback)
}
