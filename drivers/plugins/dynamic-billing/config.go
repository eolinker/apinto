...
type Config struct {
	...
	BindResourceGroupKey string         `json:"bind_resource_group_key" label:"绑定资源组 Key 模版" default:"user_bind_resource_group:{application}" description:"支持{application}, {resource}等占位符"`
}
